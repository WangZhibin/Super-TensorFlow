...
Status DirectSession::Run(const RunOptions& run_options,
  ...
  run_state_args.collective_graph_key =
      run_options.experimental().collective_graph_key();
  run_state_args.disable_mixed_precision =
      run_options.experimental().disable_mixed_precision();
  run_state_args.disable_xla =
      run_options.experimental().disable_xla();
...
Status DirectSession::CreateExecutors(
  ...
  options.disable_mixed_precision = run_state_args->disable_mixed_precision;
  options.disable_xla = run_state_args->disable_xla;
