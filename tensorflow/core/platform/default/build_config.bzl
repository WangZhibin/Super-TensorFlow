...
def tf_additional_sage2_lib_defines():
    return select({
        "//tensorflow:with_sage2_support": ["TENSORFLOW_USE_SAGE2"],
        "//conditions:default": [],
    })

def tf_additional_sage2_deps():
    return select({
        "//tensorflow:with_sage2_support": ["//tensorflow/core/lib/sage2:sage2"],
        "//conditions:default": [],
    })
